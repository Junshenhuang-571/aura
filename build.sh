...
$FC -c -std=f2018 -O2 -Wall -Jbuild -ffree-line-length-none csrc/llm_f90_src/weight_module.f90
...
$FC -c -std=f2018 -O2 -Wall -Jbuild src/aura_workspace.f90
...
# tests
$FC -Ibuild -Jbuild -o build/aura_test test/test_aura_ansi.f90 aura_ansi.o aura_theme.o aura_workspace.o \
    aura_config.o aura_session.o aura_pty.o aura_llm.o aura_pty_bridge.o \
    weight_module.o llama2_mod.o
$FC -Ibuild -Jbuild -o build/e2e_final test/e2e_final.f90 aura_ansi.o aura_theme.o aura_workspace.o aura_config.o \
